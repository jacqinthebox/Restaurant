  ...
  app.controller('profileController', function ($scope, Identity, $location, $http) {
    ...
    $scope.delete = function() {
      $http.post('/deluser/', $scope.formData).then(function(response) {
  ...
  app.controller('homeController', function ($scope, Food, $http, Identity) {
...
app.controller('feedbackController', function($scope,$stateParams) {
  ...
  app.controller('passwordResetController', function($scope,$location,$http,$stateParams) {
    ...
    console.log("stateparams :" + $stateParams.uuid);
    $scope.formData = {};
